...
* [Eclipse SUMO](https://github.com/eclipse/sumo) is coupled directly using the TraCI interface. We recommend using the SUMO release `1.16.0`.
...
* **SUMO 1.16.0** - Additionally, the environment variable `SUMO_HOME` should be configured properly.
