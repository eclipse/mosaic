...
* The coupling to [OMNeT++](https://www.nsnam.org) is implemented in a very similar manner. The corresponding federate implementation can be found [in this repository](https://github.com/mosaic-addons/omnett-federate). 
