...
public class KissRandomNumberGeneratorTest {

    private RandomNumberGenerator rng;

    @Before
    public void initRandomNumberGenerator() {
        rng = new KissRandomNumberGenerator(92659278482719L);
    }
    ...
    public void nextGaussian_simple() {
        ...
        assertEquals(0.6275783686248344, g, 0.000000001);
    }
    ...
    public void seed_sameSeed_sameResults() {
        long seed = 1000L;
        double[] first = createRandomNumbers(new KissRandomNumberGenerator(seed), 100);
        double[] second = createRandomNumbers(new KissRandomNumberGenerator(seed), 100);
    ...
    public void seed_differentSeed_differentResults() {
        double[] first = createRandomNumbers(new KissRandomNumberGenerator(1000L), 100);
        double[] second = createRandomNumbers(new KissRandomNumberGenerator(2000L), 100);
    ...
    public void seed_noSeed_differentResults() throws InterruptedException {
        double[] first = createRandomNumbers(new KissRandomNumberGenerator(), 100);
        Thread.sleep(100);
        double[] second = createRandomNumbers(new KissRandomNumberGenerator(), 100);
