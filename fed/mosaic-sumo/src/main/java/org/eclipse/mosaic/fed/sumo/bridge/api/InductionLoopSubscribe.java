...
public interface InductionLoopSubscribe {
     ...
     */
    void execute(Bridge traciCon, String inductionLoopId, long startTime, long endTime) throws CommandException, InternalFederateException;
}
