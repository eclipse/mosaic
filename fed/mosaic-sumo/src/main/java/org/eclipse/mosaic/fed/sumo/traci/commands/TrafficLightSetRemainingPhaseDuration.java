...
public class TrafficLightSetRemainingPhaseDuration extends AbstractTraciCommand<Void> {
    ...
    public void execute(TraciConnection con, String tlId, double remainingDurationS) throws TraciCommandException, InternalFederateException {
