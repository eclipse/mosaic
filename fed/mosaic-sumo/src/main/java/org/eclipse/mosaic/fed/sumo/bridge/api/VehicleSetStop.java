...
public interface VehicleSetStop {
     ...
     */
    void execute(Bridge traciCon, String vehicleId, String edgeId, double position, int laneIndex, int durationInMs, int stopFlag) throws CommandException, InternalFederateException;
}
