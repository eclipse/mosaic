...
public interface VehicleSetStop {
     ...
     */
    void execute(Bridge bridge, String vehicleId, String edgeId, double position, int laneIndex, int durationInMs, int stopFlag) throws CommandException, InternalFederateException;
}
