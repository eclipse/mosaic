 ...
 */
public class VehicleSetMaxDeceleration extends AbstractVehicleSetSingleDoubleValue {

    /**
     * Creates a new {@link VehicleSetMaxDeceleration} object.
     *
     * @see <a href="https://sumo.dlr.de/docs/TraCI/Change_Vehicle_State.html">Vehicle State Change</a>
     */
    public VehicleSetMaxDeceleration() {
        super(TraciVersion.LOWEST, CommandChangeVehicleValue.VAR_DECELERATION);
    }
}
