...
/**
 * Extension of the {@link SumoScenarioAmbassador} starting the GUI
 * of SUMO instead of the CLI.
 */
public class SumoScenarioGuiAmbassador extends SumoScenarioAmbassador {

    private int startCmdPort = -1;

    /**
     * Creates a new {@link SumoScenarioGuiAmbassador} object using
     ...
     */
    public SumoScenarioGuiAmbassador(AmbassadorParameter ambassadorParameter) {
    ...
    public FederateExecutor createFederateExecutor(String host, int port, OperatingSystem os) {
        ...
        this.federateExecutor =
                new ExecutableFederateExecutor(this.descriptor, AbstractSumoAmbassador.getSumoExecutable("sumo-gui"), super.getProgramArguments(port));
