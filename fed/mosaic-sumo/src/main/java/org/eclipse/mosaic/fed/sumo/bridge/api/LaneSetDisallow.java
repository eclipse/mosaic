 ...
 */
public interface LaneSetDisallow {
    /**
     ...
     */
    void execute(Bridge traciCon, String laneId, List<String> disallowedVClasses) throws CommandException, InternalFederateException;
}
