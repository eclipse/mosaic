 ...
 */
public class TrafficLightSetProgram extends AbstractTraciCommand<Void> {
     ...
     */
    public void execute(TraciConnection con, String tlId, String programId) throws TraciCommandException, InternalFederateException {
