...
public class VehicleSetStop
     ...
     */
    public void execute(Bridge bridge, String vehicleId, String edgeId, double position, int laneIndex, int durationInMs, int stopFlag) throws CommandException, InternalFederateException {
        super.execute(bridge, vehicleId, edgeId, position, laneIndex, durationInMs / 1000d, stopFlag);
    }
