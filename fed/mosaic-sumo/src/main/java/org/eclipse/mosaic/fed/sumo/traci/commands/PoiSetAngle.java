 ...
 */
public class PoiSetAngle extends AbstractTraciCommand<Void> {
     ...
     */
    public void execute(TraciConnection traciCon, String poiId, double angle) throws TraciCommandException, InternalFederateException {
