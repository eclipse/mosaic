...
import org.eclipse.mosaic.fed.sumo.traci.reader.TrafficLightProgramTraciReader;
 ...
 */
public class TrafficLightGetPrograms extends AbstractTraciCommand<List<SumoTrafficLightLogic>> {
     ...
     */
    public List<SumoTrafficLightLogic> execute(TraciConnection con, String tlId) throws TraciCommandException, InternalFederateException {
