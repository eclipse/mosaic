...
@Retention(RUNTIME)
@Target(METHOD)
public @interface SinceTraci {

    /**
     * Returns lowest supported TraCI version on default.
     *
     * @return Lowest supported TraCI version
     */
    TraciVersion value() default TraciVersion.LOWEST;
}
