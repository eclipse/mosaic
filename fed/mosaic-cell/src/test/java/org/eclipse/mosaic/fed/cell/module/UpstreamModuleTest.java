...
public class UpstreamModuleTest {
    ...
    @Mock
    private DestinationAddressContainer destinationAddressContainerStream;
    ...
    @Before
    public void setup() throws IllegalValueException, InternalFederateException, UnknownHostException {
        ...
        when(destinationAddressContainerStream.getProtocolType()).thenReturn(ProtocolType.TCP);
        when(destinationAddressContainerStream.getAddress()).thenReturn(mock(NetworkAddress.class));
        when(destinationAddressContainerStream.getAddress().getIPv4Address()).thenReturn(inet4Address);
        when(destinationAddressContainerStream.getType()).thenReturn(DestinationType.CELL_TOPOCAST);
        when(v2XMessage.getRouting()).thenAnswer(x -> routing.get());
    ...
    public void testProcessMessage_regularMessageNodeLimited() throws InternalFederateException {
        ...
        assertEquals(0L, SimulationData.INSTANCE.getCellConfigurationOfNode("veh_0").getAvailableUlBitrate());
    ...
    public void testProcessMessage_regularMessageNodeLimitedRegionMoreLimited() throws InternalFederateException {
        ...
        assertEquals((400 - 200) * DATA.BIT, SimulationData.INSTANCE.getCellConfigurationOfNode("veh_0").getAvailableUlBitrate());
    ...
    public void testProcessMessage_regularMessageNodeLimitedRegionBlocked() throws InternalFederateException {
        ...
        assertEquals(400 * DATA.BIT, SimulationData.INSTANCE.getCellConfigurationOfNode("veh_0").getAvailableUlBitrate());
    ...
    public void testProcessMessage_regularMessageNodeUnlimited_plusFreeBandwidth() throws InternalFederateException {
        ...
        // ASSERT
        assertEquals(Long.MAX_VALUE * DATA.BIT, SimulationData.INSTANCE.getCellConfigurationOfNode("veh_0").getAvailableUlBitrate());
    ...
    public void testProcessMessage_regularMessageNodeUnlimitedRegionLimited() throws InternalFederateException {
        ...
        assertEquals(
                ...
                SimulationData.INSTANCE.getCellConfigurationOfNode("veh_0").getAvailableUlBitrate()
        );
        assertEquals(0L, ConfigurationData.INSTANCE.getNetworkConfig().globalNetwork.uplink.capacity);
    ...
    public void testProcessMessage_nodeCapacityExceededRegionUnlimited() throws InternalFederateException {
        ...
        cellConfiguration.consumeUl(Long.MAX_VALUE * DATA.BIT);
    ...
    @Test
    public void testProcessMessage_nodeNotRegisteredTcp() throws InternalFederateException {
        // SETUP
        // TCP
        routing.set(new MessageRouting(destinationAddressContainer, sourceAddressContainerMock));
    ...
    public void testFreeBandwidth_regularMessage() {
        ...
        // ASSERT
        assertEquals(200 * DATA.BIT, cellConfiguration.getAvailableUlBitrate());

        // RUN
        upstreamModule.processEvent(event);

        // ASSERT
        assertEquals(400 * DATA.BIT, cellConfiguration.getAvailableUlBitrate());
        assertEquals(21000 * DATA.BIT, ConfigurationData.INSTANCE.getNetworkConfig().globalNetwork.uplink.capacity);
    }
    ...
    private void checkRtiMessages(List<NegativeAckReason> negativeAckReasons, SampleV2xMessage sampleV2XMessage) {
        assertTrue(rtiMessagesSent.get(0) instanceof V2xMessageAcknowledgement);
        V2xMessageAcknowledgement ackV2xMessage = (V2xMessageAcknowledgement) rtiMessagesSent.get(0);
