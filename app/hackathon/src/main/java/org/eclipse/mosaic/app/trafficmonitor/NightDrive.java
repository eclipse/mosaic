...
*/
public class NightDrive extends AbstractApplication<VehicleOperatingSystem> implements VehicleApplication {
   ...
   public NightDrive() {
       this.activityDuration =
               Math.max(1, (long) (0.5 * TIME.SECOND * 3600) + (getRandom().nextLong(0, 3600) - 1800) * TIME.SECOND);
   }
